...
| **Risk-Adjusted Metrics** | Is our fraud detector worth the investment? | Sharpe, Sortino, Information Ratio, Calmar — bootstrapped over 49 pseudo-periods; radar scorecard with natural [0,1] axes (Avg TPR, Consistency, Floor, vs Benchmark) that change visibly across n_periods runs; TPR series vs naive benchmark; drawdown chart |
