...
| **Risk-Adjusted Metrics** | Is our fraud detector worth the investment? | Sharpe, Sortino, Information Ratio, Calmar — bootstrapped over 49 pseudo-periods; radar with dual-perspective toggle: **Finance** view (Sharpe/Sortino/IR/Calmar, log-scaled) or **ML** view (Avg TPR, Consistency, Floor, vs Benchmark — changes with n_periods); TPR series vs naive benchmark; drawdown chart |
